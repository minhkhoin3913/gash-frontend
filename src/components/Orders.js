            ...
            <article key={order._id} className="orders-order-card">
              <div className="orders-order-header">
                <div className="orders-order-info">
                  ...
                  <p
                    className={`orders-order-status ${order.order_status?.toLowerCase()}`}
                  >
                    Status: {order.order_status || "N/A"}
                  </p>
                  <p className="orders-order-payment">
                    Payment: {order.pay_status || "N/A"}
                  </p>
                  <p className="orders-order-shipping">
                    Shipping: {order.shipping_status || "N/A"}
                  </p>
                </div>
                <button
                        ...
                        <div key={detail._id} className="orders-detail-item">
                          <div className="orders-detail-info">
                            ...
                            <p className="orders-detail-variant">
                              Color:{" "}
                              {detail.variant_id?.color_id?.color_name || "N/A"}
                              , Size:{" "}
                                ...
                                detail.feedback_details !== "None" ? (
                                  <>
                                    ...
                                    <button
                                      ...
                                      disabled={loading}
                                      aria-label={`Delete feedback for ${
                                        detail.variant_id?.pro_id?.pro_name ||
                                        "product"
                                      }`}
                                    >
                                  ...
                                  <button
                                    ...
                                    onClick={() =>
                                      toggleFeedbackForm(detail._id)
                                    }
                                    disabled={loading}
                                    aria-label={`Provide feedback for ${
                                      detail.variant_id?.pro_id?.pro_name ||
                                      "product"
                                    }`}
                                  >
                                    {feedbackFormVisible[detail._id]
                                      ? "Cancel"
                                      : "Provide Feedback"}
                                  </button>
                                )}
                                ...
                                <div className="orders-feedback-form">
                                  ...
                                  <button
                                    ...
                                    onClick={() =>
                                      submitFeedback(
                                        detail._id,
                                        feedbackInputs[detail._id]
                                      )
                                    }
                                    disabled={
                                      loading ||
                                      !feedbackInputs[detail._id]?.trim()
                                    }
                                    aria-label={`Submit feedback for ${
                                      detail.variant_id?.pro_id?.pro_name ||
                                      "product"
                                    }`}
                                  >
